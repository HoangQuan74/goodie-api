...
import (
	...
	"github.com/HoangQuan74/goodie-api/services/merchant/config"
	"go.uber.org/zap"
)
...
func main() {
	...
	v1 := router.Group("/api/v1/merchant")
	...
	go func() {
		log.Info("merchant service starting", zap.String("port", cfg.Server.Port))
	...
	log.Info("shutting down merchant service...")
	...
	log.Info("merchant service stopped")
}
